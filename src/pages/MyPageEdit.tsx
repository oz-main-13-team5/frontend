...
export default function MyPageEdit() {
  return (
    <div className="flex justify-center p-5">
      <div className="flex w-full flex-col items-center justify-start gap-5 sm:max-w-96 sm:justify-center">
        <div className="flex w-full flex-col items-start justify-center gap-2 sm:items-center">
